...
**Hinweis:** Wir erfassen KEINE Absturzberichte oder Analysedaten. Fehlerprotokolle werden nur lokal auf Ihrem Gerät gespeichert.
...
- Den geschätzten Wert Ihrer Sammlung zu berechnen
- Ihre Ersparnisse und Gaming-Ziele zu verfolgen
- Wichtige Service-Benachrichtigungen zu senden
- Die App basierend auf Nutzungsmustern zu verbessern
...
- Speichert Ihre Konto- und Sammlungsdaten
- Datenschutzerklärung: https://supabase.com/privacy

### 4.2 RevenueCat (Abonnement-Verwaltung)
- Verwaltet Premium-Abonnements
- Datenschutzerklärung: https://www.revenuecat.com/privacy

### 4.3 Google Gemini AI (Regal-Scanner)
- Verarbeitet Fotos zur Spielerkennung (Bilder werden nicht gespeichert)
- Datenschutzerklärung: https://policies.google.com/privacy

### 4.4 IGDB (Spiele-Datenbank)
- Liefert Spieleinformationen und Cover-Bilder
...
- **Löschung**: Ihr Konto und alle zugehörigen Daten zu löschen
...
- Gelöschte Konten: Alle Daten werden innerhalb von 30 Tagen dauerhaft gelöscht
...
*Diese Datenschutzerklärung gilt ab dem 3. Februar 2026.*
